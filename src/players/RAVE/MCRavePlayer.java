...
public class MCRavePlayer extends ParameterizedPlayer {
    ...
    public MCRavePlayer(long seed, int id) {
        this(seed, id, new MCTSParams());
    }

    public MCRavePlayer(long seed, int id, MCTSParams params) {
    ...
    public Types.ACTIONS act(GameState gs) {
        ...
        // Root of the tree
        MCRAVE m_root = new MCRAVE(params, m_rnd, num_actions, actions);
    ...
    @Override
    public Player copy() {
        return new MCRavePlayer(seed, playerID, params);
    }
}
